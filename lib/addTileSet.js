 ...
 * @param {object} data data about a map
...
function setupProcessJob(dbTable, data, id) {
	...
	var job = jobs.create('process', {
		...
		.on('complete', function () {
			...
			updateTileSetStatus(dbTable, job.data.mapId, utils.tileSetStatus.failed);
 ...
 * @param {object} data  - object with map data
 * @returns {object} - promise
 */
