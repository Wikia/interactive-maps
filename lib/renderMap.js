...
function createAttributionText(mapData) {
	return '<div id="edit">' +
		'<a class="sprite edit" href="http://mediawiki119.wikia.com/wiki/Special:Maps/120" target="_blank">Edit Map</a>' +
		'</div>' +
		'<a class="logo" href="http://www.wikia.com" target="_blank"><img src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D" class="sprite" height="38" width="220" /></a>'+
		'<a href="#" class="comm">mediawiki119.wikia.com</a>';
//
//
//	return i18n.msg('wikia-interactive-maps-created-by', language, [mapData.city_title]) +
//		'<a class="edit" href="' + createEditMapUrl(mapData.city_url, mapData.id) + '" target="_blank">' +
//		i18n.msg('wikia-interactive-maps-edit-on-wikia', language) +
//		'</a>';
}
