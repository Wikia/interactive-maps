...
if (!env.WIKIA_DATACENTER) {
	throw 'WIKIA_DATACENTER seems to be not set';
}
...
configuration.swift = mwConfiguration.wgFSSwiftDC[yamlEnv][env.WIKIA_DATACENTER];
configuration.taskBroker = mwConfiguration.wgTaskBroker[yamlEnv];
